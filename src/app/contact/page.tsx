...
const artworks = [
  { id: '1', title: 'Sunset Dreams' },
  { id: '2', title: 'Mountain Reflection' },
  { id: '3', title: 'Urban Poetry' },
  { id: '4', title: 'Garden Dance' },
  { id: '5', title: 'Abstract Horizons' },
  { id: '6', title: 'Winter Silence' },
]
        ...
        <div className="mx-auto max-w-2xl space-y-8 text-olive-950 dark:text-white">
          <div className="grid gap-6 sm:grid-cols-2">
            <div>
              ...
              <Text>Use the form below to reach out about artwork purchases, commissions, or gallery collaborations.</Text>
            </div>
            <div>
              <Subheading>Commission Work</Subheading>
              <Text>I accept commissions for custom pieces. Let me know your vision and I'll work with you to create something unique.</Text>
            </div>
          </div>
        </div>
      </Section>
